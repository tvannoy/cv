...
\cvlistitem{Drone propeller rotation analysis}
\cvlistitem{Insect detection using supervised machine learning}
\cvlistitem{Fish detection using supervised machine learning}

\cventry{Aug 2017\,--\,May 2019}{Graduate Research Assistant}{Montana State University}{Bozeman, MT}{}{\href{https://github.com/fpga-open-speec-tools/}{Development of an open source FPGA-based speech processing platform \faGithub}}
\cvlistitem{Developed code generation and workflow automation scripts to reduce development time}
